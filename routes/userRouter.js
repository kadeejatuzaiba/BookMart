...
router.post(
  ...
  profileController.profileUpload
);
...
router.post(
  '/increase-quantity/:itemId',
  userAuth,
  cartController.increaseQuantity
);
router.post(
  '/decrease-quantity/:itemId',
  userAuth,
...
router.get(
  ...
  userAuth,
  orderController.getretryPayment
);

// retry payment
router.put('/retry-payment/cod/:orderId', userAuth, orderController.retryCOD);
router.put(
  '/retry-payment/wallet/:orderId',
  userAuth,
  orderController.retryWallet
);
